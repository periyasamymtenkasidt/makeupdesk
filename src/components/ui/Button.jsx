const VARIANTS = {
  ...
  dark:        { background: 'var(--btn-dark-bg)',         color: 'var(--btn-dark-color)',         border: '1.5px solid var(--btn-dark-border)'         },
  darkOutline: { background: 'var(--btn-dark-outline-bg)', color: 'var(--btn-dark-outline-color)', border: '1.5px solid var(--btn-dark-outline-border)'  },
