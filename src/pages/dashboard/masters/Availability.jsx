    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Clock size={15} style={{ color: "var(--icon-booking)" }} />{" "}
            Availability Master
          </Link>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <div style={section}>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      boxShadow: active
                        ? "0 2px 8px rgba(201,149,108,0.35)"
                        : "none",
                    }}
                  >
                    {d.label}
            ...
            >
              Clients can only book on selected days. Off days show "Artist
              unavailable."
            </p>
          </div>
          ...
          <div style={section}>
            ...
            >
              <div>
                <label style={{ ...lbl, marginBottom: "4px" }}>
                  Start Time
                </label>
                <input
                  type="time"
